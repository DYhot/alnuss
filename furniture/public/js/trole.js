...
function roleQuery(){
    ...
    var querydetail={role_name:role_name,role_script:role_script,role_state:role_state}
    console.log("角色名 ",role_name,"角色权限描述",role_script, "标签状态",role_state)
    $.ajax({
        url:"/queryRole",
        type:"get",
...
//        if(parent.find(".role_name").val()=="")
//        {
//            console.log("验证标签名1-1")
//            parent.find(".role_name").parents(".form-group").next().css({"display":"block"})
//            parent.find(".role_name").parents(".form-group").next().find("label").html("标签名称不能为空")
//            console.log("标签名称不能为空")
//            queryok=false;
//        }else if(!/^[\u4e00-\u9fa5][\u4e00-\u9fa5a-zA-Z\d]+$/.test(parent.find(".role_name").val()))
//        { console.log("验证标签名1")
//            parent.find(".role_name").parents(".form-group").next().css({"display":"block"})
//            parent.find(".role_name").parents(".form-group").next().find("label").html("标签名必须为中文开头")
//            queryok=false;
//            console.log("标签名必须为中文开头")
//        }
//        if(parent.find(".role_script").val()=="")
//        {
//            console.log("验证标签名2-1")
//            parent.find(".role_script").parents(".form-group").next().css({"display":"block"})
//
//            parent.find(".role_script").parents(".form-group").next().find("label").html("权限描述不能为空")
//            queryok=false;
//            console.log("权限描述不能为空")
//        }else if(!/^[\u4e00-\u9fa5][\u4e00-\u9fa5a-zA-Z\d]+$/.test(parent.find(".role_script").val()))
//        { console.log("验证标签名2")
//            parent.find(".role_script").parents(".form-group").next().css({"display":"block"})
//
//            parent.find(".role_script").parents(".form-group").next().find("label").html("权限描述必须为中文开头")
//            queryok=false;
//            console.log("权限描述必须为中文开头")
//        }
//        if(parent.find(".role_remark").val()=="")
//        {
//            console.log("验证角色备注3-1")
//            parent.find(".role_remark").parents(".form-group").next().css({"display":"block"})
//
//            parent.find(".role_remark").parents(".form-group").next().find("label").html("角色备注信息不能为空")
//            queryok=false;
//            console.log("角色备注信息不能为空")
//        }else if(!/^[\u4e00-\u9fa5][\u4e00-\u9fa5a-zA-Z\d]+$/.test(parent.find(".role_remark").val()))
//        { console.log("验证标签名3")
//            parent.find(".role_remark").parents(".form-group").next().css({"display":"block"})
//
//            parent.find(".role_remark").parents(".form-group").next().find("label").html("角色备注信息必须为中文开头")
//            queryok=false;
//            console.log("角色备注信息必须为中文开头")
//        }
//        let checbox=0;
